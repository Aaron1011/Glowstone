...
public final class UpdateBlockEntityMessage implements Message {
    ...
    /*public UpdateBlockEntityMessage(Location location, int action, CompoundTag nbt) {
        UpdateBlockEntityMessage((int) location.getX(), (int) location.getY(), (int) location.getZ(), action, nbt);
    }*/
